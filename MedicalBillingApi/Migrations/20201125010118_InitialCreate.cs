        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityReference = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrugStores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DrugStores_Services_DrugId",
                        column: x => x.DrugId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrugStores_AspNetUsers_PharmacistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceItems_Services_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceItems_Receipts_ReceiptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrugStores_DrugId",
                table: "DrugStores",
                column: "DrugId");

            migrationBuilder.CreateIndex(
                name: "IX_DrugStores_PharmacistId",
                table: "DrugStores",
                column: "PharmacistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItems_ReceiptId",
                table: "InvoiceItems",
                column: "ReceiptId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_BillerId",
                table: "Invoices",
                column: "BillerId");
